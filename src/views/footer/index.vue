  ...
  <div>
    ...
    <div class="button-group">
      <div class="button-row">
        <button class="button intro-button" @click="handleClick('1')">简介<span class="button-icon"></span>  </button>
        <button class="button poetry-button" @click="handleClick('2')">古诗<span class="button-icon"></span>  </button>
        <button class="button custom-button" @click="handleClick('3')">习俗<span class="button-icon"></span>  </button>
        <button class="button pic-button" @click="handleClick('4')">画作<span class="button-icon"></span>  </button>
        <button class="button book-button" @click="handleClick('5')">书籍
